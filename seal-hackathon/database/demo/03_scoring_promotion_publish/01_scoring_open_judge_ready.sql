...
DECLARE @ScenarioKey NVARCHAR(120) = N'qualifier_submission_closed_scoring_open';
DECLARE @ScenarioTitle NVARCHAR(180) = N'Qualifier submission closed scoring open';
DECLARE @ScenarioDescription NVARCHAR(500) = N'Lifecycle demo: Qualifier submission is closed, all teams have submitted, and judge scoring has not started yet.';
DECLARE @ScenarioNow DATETIME2 = '2026-07-15T09:00:00';
DECLARE @PublishedAt DATETIME2 = '2026-06-25T09:00:00';
DECLARE @RegistrationStart DATETIME2 = '2026-06-27T09:00:00';
DECLARE @RegistrationEnd DATETIME2 = '2026-07-05T09:00:00';
DECLARE @CompetitionStart DATETIME2 = '2026-07-07T09:00:00';
DECLARE @CompetitionEnd DATETIME2 = '2026-08-02T09:00:00';
DECLARE @QualifierStart DATETIME2 = '2026-07-07T09:00:00';
DECLARE @QualifierDeadline DATETIME2 = '2026-07-14T09:00:00';
DECLARE @QualifierEnd DATETIME2 = '2026-07-17T09:00:00';
DECLARE @FinalStart DATETIME2 = '2026-07-27T09:00:00';
DECLARE @FinalDeadline DATETIME2 = '2026-07-31T09:00:00';
DECLARE @FinalEnd DATETIME2 = '2026-08-02T09:00:00';
