...
DECLARE @ScenarioKey NVARCHAR(120) = N'qualifier_scoring_closed_ready_for_finalize';
DECLARE @ScenarioTitle NVARCHAR(180) = N'Qualifier scoring closed ready for finalize';
DECLARE @ScenarioDescription NVARCHAR(500) = N'Lifecycle demo: Qualifier scoring time is over, all qualifier submissions already have scores, and the coordinator can finalize then promote teams.';
DECLARE @ScenarioNow DATETIME2 = '2026-07-23T09:00:00';
DECLARE @PublishedAt DATETIME2 = '2026-06-29T09:00:00';
DECLARE @RegistrationStart DATETIME2 = '2026-07-01T09:00:00';
DECLARE @RegistrationEnd DATETIME2 = '2026-07-09T09:00:00';
DECLARE @CompetitionStart DATETIME2 = '2026-07-11T09:00:00';
DECLARE @CompetitionEnd DATETIME2 = '2026-08-06T09:00:00';
DECLARE @QualifierStart DATETIME2 = '2026-07-11T09:00:00';
DECLARE @QualifierDeadline DATETIME2 = '2026-07-19T09:00:00';
DECLARE @QualifierEnd DATETIME2 = '2026-07-22T09:00:00';
DECLARE @FinalStart DATETIME2 = '2026-07-31T09:00:00';
DECLARE @FinalDeadline DATETIME2 = '2026-08-04T09:00:00';
DECLARE @FinalEnd DATETIME2 = '2026-08-06T09:00:00';
