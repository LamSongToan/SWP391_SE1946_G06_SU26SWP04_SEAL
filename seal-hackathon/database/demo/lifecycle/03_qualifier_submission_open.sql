...
DECLARE @ScenarioKey NVARCHAR(120) = N'qualifier_submission_open';
DECLARE @ScenarioTitle NVARCHAR(180) = N'Qualifier submission open';
DECLARE @ScenarioDescription NVARCHAR(500) = N'Lifecycle demo: Registration is closed, the qualifier is open for submission, and no team has submitted yet.';
DECLARE @ScenarioNow DATETIME2 = '2026-07-15T09:00:00';
DECLARE @PublishedAt DATETIME2 = '2026-07-01T09:00:00';
DECLARE @RegistrationStart DATETIME2 = '2026-07-03T09:00:00';
DECLARE @RegistrationEnd DATETIME2 = '2026-07-13T09:00:00';
DECLARE @CompetitionStart DATETIME2 = '2026-07-14T09:00:00';
DECLARE @CompetitionEnd DATETIME2 = '2026-08-08T09:00:00';
DECLARE @QualifierStart DATETIME2 = '2026-07-14T09:00:00';
DECLARE @QualifierDeadline DATETIME2 = '2026-07-18T09:00:00';
DECLARE @QualifierEnd DATETIME2 = '2026-07-20T09:00:00';
DECLARE @FinalStart DATETIME2 = '2026-07-30T09:00:00';
DECLARE @FinalDeadline DATETIME2 = '2026-08-03T09:00:00';
DECLARE @FinalEnd DATETIME2 = '2026-08-05T09:00:00';
