...
DECLARE @ScenarioKey NVARCHAR(120) = N'event_ended_full_results';
DECLARE @ScenarioTitle NVARCHAR(180) = N'Event ended full results';
DECLARE @ScenarioDescription NVARCHAR(500) = N'Lifecycle demo: Summer 2026 is fully completed with submissions, scores, rankings, awards, and no further participation allowed.';
DECLARE @ScenarioNow DATETIME2 = '2026-07-15T09:00:00';
DECLARE @PublishedAt DATETIME2 = '2026-05-31T09:00:00';
DECLARE @RegistrationStart DATETIME2 = '2026-06-02T09:00:00';
DECLARE @RegistrationEnd DATETIME2 = '2026-06-10T09:00:00';
DECLARE @CompetitionStart DATETIME2 = '2026-06-12T09:00:00';
DECLARE @CompetitionEnd DATETIME2 = '2026-07-14T09:00:00';
DECLARE @QualifierStart DATETIME2 = '2026-06-12T09:00:00';
DECLARE @QualifierDeadline DATETIME2 = '2026-06-19T09:00:00';
DECLARE @QualifierEnd DATETIME2 = '2026-06-22T09:00:00';
DECLARE @FinalStart DATETIME2 = '2026-07-01T09:00:00';
DECLARE @FinalDeadline DATETIME2 = '2026-07-05T09:00:00';
DECLARE @FinalEnd DATETIME2 = '2026-07-08T09:00:00';
DECLARE @EventStatus VARCHAR(30) = 'Ended';
...
DECLARE @LockFinalRound BIT = 1;
DECLARE @PublishFinalResults BIT = 1;
