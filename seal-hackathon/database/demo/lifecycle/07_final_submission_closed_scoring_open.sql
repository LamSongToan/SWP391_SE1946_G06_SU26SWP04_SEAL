...
DECLARE @ScenarioKey NVARCHAR(120) = N'final_submission_closed_scoring_open';
DECLARE @ScenarioTitle NVARCHAR(180) = N'Final submission closed scoring open';
DECLARE @ScenarioDescription NVARCHAR(500) = N'Lifecycle demo: Final submission is closed, finalists have submitted, and final scoring has not started yet.';
DECLARE @ScenarioNow DATETIME2 = '2026-07-23T09:00:00';
DECLARE @PublishedAt DATETIME2 = '2026-06-19T09:00:00';
DECLARE @RegistrationStart DATETIME2 = '2026-06-21T09:00:00';
DECLARE @RegistrationEnd DATETIME2 = '2026-06-29T09:00:00';
DECLARE @CompetitionStart DATETIME2 = '2026-07-01T09:00:00';
DECLARE @CompetitionEnd DATETIME2 = '2026-07-30T09:00:00';
DECLARE @QualifierStart DATETIME2 = '2026-07-01T09:00:00';
DECLARE @QualifierDeadline DATETIME2 = '2026-07-08T09:00:00';
DECLARE @QualifierEnd DATETIME2 = '2026-07-11T09:00:00';
DECLARE @FinalStart DATETIME2 = '2026-07-18T09:00:00';
DECLARE @FinalDeadline DATETIME2 = '2026-07-22T09:00:00';
DECLARE @FinalEnd DATETIME2 = '2026-07-25T09:00:00';
