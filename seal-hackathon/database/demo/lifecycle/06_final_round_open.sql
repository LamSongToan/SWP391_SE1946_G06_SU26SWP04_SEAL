...
DECLARE @ScenarioKey NVARCHAR(120) = N'final_round_open';
DECLARE @ScenarioTitle NVARCHAR(180) = N'Final round open';
DECLARE @ScenarioDescription NVARCHAR(500) = N'Lifecycle demo: Qualifier is finalized, promoted, and published; the final round is open and finalists have not submitted yet.';
DECLARE @ScenarioNow DATETIME2 = '2026-07-15T09:00:00';
DECLARE @PublishedAt DATETIME2 = '2026-06-15T09:00:00';
DECLARE @RegistrationStart DATETIME2 = '2026-06-17T09:00:00';
DECLARE @RegistrationEnd DATETIME2 = '2026-06-25T09:00:00';
DECLARE @CompetitionStart DATETIME2 = '2026-06-27T09:00:00';
DECLARE @CompetitionEnd DATETIME2 = '2026-07-25T09:00:00';
DECLARE @QualifierStart DATETIME2 = '2026-06-27T09:00:00';
DECLARE @QualifierDeadline DATETIME2 = '2026-07-04T09:00:00';
DECLARE @QualifierEnd DATETIME2 = '2026-07-07T09:00:00';
DECLARE @FinalStart DATETIME2 = '2026-07-14T09:00:00';
DECLARE @FinalDeadline DATETIME2 = '2026-07-18T09:00:00';
DECLARE @FinalEnd DATETIME2 = '2026-07-20T09:00:00';
