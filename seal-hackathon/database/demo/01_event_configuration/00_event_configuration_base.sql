...
DECLARE @ScenarioKey NVARCHAR(120) = N'base_system_clean';
DECLARE @ScenarioTitle NVARCHAR(180) = N'Base system clean';
DECLARE @ScenarioDescription NVARCHAR(500) = N'Lifecycle demo: Summer 2026 exists with no teams, no registrations, and no submissions yet.';
DECLARE @ScenarioNow DATETIME2 = '2026-07-23T09:00:00';
DECLARE @PublishedAt DATETIME2 = '2026-07-22T09:00:00';
DECLARE @RegistrationStart DATETIME2 = '2026-07-25T09:00:00';
DECLARE @RegistrationEnd DATETIME2 = '2026-08-01T09:00:00';
DECLARE @CompetitionStart DATETIME2 = '2026-08-04T09:00:00';
DECLARE @CompetitionEnd DATETIME2 = '2026-09-01T09:00:00';
DECLARE @QualifierStart DATETIME2 = '2026-08-04T09:00:00';
DECLARE @QualifierDeadline DATETIME2 = '2026-08-10T09:00:00';
DECLARE @QualifierEnd DATETIME2 = '2026-08-12T09:00:00';
DECLARE @FinalStart DATETIME2 = '2026-08-20T09:00:00';
DECLARE @FinalDeadline DATETIME2 = '2026-08-24T09:00:00';
DECLARE @FinalEnd DATETIME2 = '2026-08-26T09:00:00';
DECLARE @EventStatus VARCHAR(30) = 'Ongoing';

DECLARE @IncludeTeams BIT = 0;
