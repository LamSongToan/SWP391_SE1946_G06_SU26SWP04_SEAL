...
DECLARE @ScenarioKey NVARCHAR(120) = N'individual_matching_track_balance';
DECLARE @ScenarioTitle NVARCHAR(180) = N'Individual matching and track balance';
DECLARE @ScenarioDescription NVARCHAR(500) = N'Lifecycle demo: Registration has closed with three unmatched AI & Data students and an uneven 6-to-2 track distribution. Opening Team Management auto-forms their team, then the coordinator can balance tracks from 6-to-3 into a valid 5-to-4 setup.';
...
DECLARE @CompetitionStart DATETIME2 = '2026-07-26T09:00:00';
DECLARE @CompetitionEnd DATETIME2 = '2026-08-22T09:00:00';
DECLARE @QualifierStart DATETIME2 = '2026-07-26T09:00:00';
DECLARE @QualifierDeadline DATETIME2 = '2026-07-31T09:00:00';
DECLARE @QualifierEnd DATETIME2 = '2026-08-02T09:00:00';
DECLARE @FinalStart DATETIME2 = '2026-08-12T09:00:00';
DECLARE @FinalDeadline DATETIME2 = '2026-08-16T09:00:00';
DECLARE @FinalEnd DATETIME2 = '2026-08-18T09:00:00';
DECLARE @EventStatus VARCHAR(30) = 'Ongoing';

DECLARE @IncludeTeams BIT = 1;
DECLARE @IncludeWaitingIndividuals BIT = 1;
DECLARE @IncludeQualifierSubmissions BIT = 0;
DECLARE @IncludeQualifierScores BIT = 0;
DECLARE @LockQualifierRound BIT = 0;
DECLARE @CalculateQualifier BIT = 0;
DECLARE @ApplyAdvancement BIT = 0;
DECLARE @PublishQualifierResults BIT = @ApplyAdvancement;
DECLARE @IncludeFinalSubmissions BIT = 0;
DECLARE @IncludeFinalScores BIT = 0;
...
(6, N'Web Orbit', N'Web Platform', 'AIDT1001', 'ai-pioneers', 8.75, 9.32, 1),
...
VALUES
('huy.student', N'AI & Data'),
('minh.student', N'AI & Data'),
