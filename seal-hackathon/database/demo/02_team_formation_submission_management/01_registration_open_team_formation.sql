...
DECLARE @ScenarioKey NVARCHAR(120) = N'registration_open';
DECLARE @ScenarioTitle NVARCHAR(180) = N'Registration open';
DECLARE @ScenarioDescription NVARCHAR(500) = N'Lifecycle demo: Summer 2026 registration is open, teams already exist, no submission has been made yet, and individual registration is left empty for manual testing.';
DECLARE @ScenarioNow DATETIME2 = '2026-07-15T09:00:00';
DECLARE @PublishedAt DATETIME2 = '2026-07-10T09:00:00';
DECLARE @RegistrationStart DATETIME2 = '2026-07-13T09:00:00';
DECLARE @RegistrationEnd DATETIME2 = '2026-07-20T09:00:00';
DECLARE @CompetitionStart DATETIME2 = '2026-07-22T09:00:00';
DECLARE @CompetitionEnd DATETIME2 = '2026-08-19T09:00:00';
DECLARE @QualifierStart DATETIME2 = '2026-07-22T09:00:00';
DECLARE @QualifierDeadline DATETIME2 = '2026-07-27T09:00:00';
DECLARE @QualifierEnd DATETIME2 = '2026-07-29T09:00:00';
DECLARE @FinalStart DATETIME2 = '2026-08-08T09:00:00';
DECLARE @FinalDeadline DATETIME2 = '2026-08-12T09:00:00';
DECLARE @FinalEnd DATETIME2 = '2026-08-14T09:00:00';
